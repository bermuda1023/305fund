...
export function initDb(): void {
  ...
  const migrations = [
    ...
    `ALTER TABLE bank_uploads ADD COLUMN file_sha256 TEXT`,
    `ALTER TABLE bank_uploads ADD COLUMN uploaded_by TEXT`,
    ...
    `ALTER TABLE cash_flow_actuals ADD COLUMN bank_transaction_id INTEGER REFERENCES bank_transactions(id)`,
    `ALTER TABLE cash_flow_actuals ADD COLUMN entity_id INTEGER REFERENCES entities(id)`,
    `ALTER TABLE cash_flow_actuals ADD COLUMN unit_renovation_id INTEGER REFERENCES unit_renovations(id)`,
